...
const App = () => {
    return (
        <Router>
            <ScrollToTop />
            <CustomScrollbar />
            <div className="overflow-x-hidden text-neutral-900 dark:text-neutral-300 antialiased selection:bg-blue-300 selection:text-blue-900 transition-colors duration-300">
