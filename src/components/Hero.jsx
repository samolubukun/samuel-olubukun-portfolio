...
import resumePdf from "../assets/samuel_olubukun_resume.pdf"; // Import your resume PDF
...
const Hero = () => {
  ...
  return (
    <div className="border-b border-neutral-900 pb-4 lg:mb-35 flex flex-wrap justify-center -mt-24"
    style={{ transform: "translateY(-0.8cm)" }}>
      <div className="w-full lg:w-1/2">
        <div className="flex flex-col items-center lg:items-start">
          <motion.h1 
            ...
            initial="hidden"
            animate="visible"
            className="pb-8 text-6xl font-thin tracking-tight lg:mt-16 lg:text-6xl"> {/* Reduced pb for button space */}
            Samuel Olubukun
          </motion.h1>
          <motion.span 
          ...
          <motion.a
            variants={container(1.5)} // Added a slight delay for the button animation
            initial="hidden"
            animate="visible"
            href={resumePdf} // Use the imported resumePdf variable
