...
const Expertise = () => {
    return (
        <div className="border-b border-neutral-200 dark:border-neutral-900 pb-20 transition-colors duration-300">
            ...
            >
                Key <span className="text-neutral-400 dark:text-neutral-500 font-normal">Expertise</span>
            </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {EXPERT_AREAS.map((area, index) => (
                        <motion.div
                            ...
                            className="p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-100/50 dark:bg-neutral-900/50 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50 transition-colors duration-300 shadow-sm dark:shadow-none"
                        >
